...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        UserSettingsDao.createTable(db, ifNotExists);
        BackupFileDao.createTable(db, ifNotExists);
        BackupInfoDao.createTable(db, ifNotExists);
        TransferHistoryDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        UserSettingsDao.dropTable(db, ifExists);
        BackupFileDao.dropTable(db, ifExists);
        BackupInfoDao.dropTable(db, ifExists);
        TransferHistoryDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(BackupFileDao.class);
        registerDaoClass(BackupInfoDao.class);
        registerDaoClass(TransferHistoryDao.class);
    }
