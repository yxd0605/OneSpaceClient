...
public class GlideCatchUtil {
    ...
    public String getCacheSize() {
        try {
            Log.d("GlideCatchUtil","path======="+MyApplication.getAppContext().getExternalCacheDir());
            String path = MyApplication.getAppContext().getExternalCacheDir()+"/"+GlideCatchConfig.GLIDE_CARCH_DIR;
            return getFormatSize(getFolderSize(new File(String.valueOf(path))));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
