...
import com.eli.oneos.widget.pullrefresh.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection,
		...
		mHeaderProgress = (View) mInnerLayout.findViewById(R.id.pull_to_refresh_progress);
		...
		default:
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrDrawableStart)) {
				...
				PullToRefreshUtils.warnDeprecation("ptrDrawableTop", "ptrDrawableStart");
		...
		case PULL_FROM_END:
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrDrawableEnd)) {
				...
				PullToRefreshUtils.warnDeprecation("ptrDrawableBottom", "ptrDrawableEnd");
