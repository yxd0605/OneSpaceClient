...
public interface StickyGridHeadersBaseAdapter extends ListAdapter {
	...
	/**
	 * Get the number of items with a given header should shown
	 * 
	 * @param header section The header in the adapter's data set.
	 * @return The number of items shown for the specified header.
	 */
	public int getShowCountForHeader(int header);
	 ...
	 * 
	 * @param position The position of the header within the adapter's header data set.
	...
	/**
	 * toggle gridview header item state, default is open
	 * 
	 * @param position
	 */
	void toggleHeader(long position);
}
