package com.eli.lib.segementgroup;
...
public class SegmentedGroup extends RadioGroup {
	...
	private int mCheckedTextColor = 0xFF03A9F4;
	...
	private void updateBackground(View view, int checked, int unchecked) {
		...
		ColorStateList colorStateList = new ColorStateList(new int[][] { { android.R.attr.state_pressed },
				{ -android.R.attr.state_pressed, -android.R.attr.state_checked }, { -android.R.attr.state_pressed, android.R.attr.state_checked } }, new int[] {
				mTintColor, mTintColor, mCheckedTextColor });
